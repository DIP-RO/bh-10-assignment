...
const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        loader: ({ params }) => fetch(`https://assignment-10-server-main-pi.vercel.app/course/${params.course_id}`)
                    },
            ...
            {
                path: "/primium/:id",
                loader: ({ params }) => fetch(`https://assignment-10-server-main-pi.vercel.app/course/${params.id}`),
                element:
                    <ProtectRoute>
                        <Primium></Primium>
                    </ProtectRoute>
